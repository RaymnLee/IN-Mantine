...
import { Grid, Group, Container, Divider, Space } from "@mantine/core";
import CardItem from "./card";
import Segment from "./SegmentedControl";
            ...
            <Grid.Col lg={8} md={9} sm={10}>
              {cryptoProjects.map((project, index) => (
                <React.Fragment key={index}>
                  ...
                  />
                  {index < cryptoProjects.length - 1 && <Divider my="xs" />}
                </React.Fragment>
              ))}
            </Grid.Col>
            <Grid.Col span={0}>
